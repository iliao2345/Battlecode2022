...
//		}
//		else {
			WARZONE_BUFFER = (Info.health > 30)? 5 : 8;
...
//		}
		...
		miners_needed_locally = Math.max(1, (int)Math.ceil(total_lead/200.));
	}
...
//			}
			if (Info.n_friendly_archons==0) {
				Direction dir = Bfs.way_to(Info.spawn_loc, Info.average_rubble, true);
				Action.move(dir);
				return true;
			}
		}
