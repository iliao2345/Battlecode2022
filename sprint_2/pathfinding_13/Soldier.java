...
//				Direction dir = Bfs.way_to(healing_loc, 100, true);
		...
		else if ((Micro.chase_enemy_econ_units && Comms.closest_attacker_dist > 7 && Info.n_enemy_attackers==0 || Info.n_enemy_archons>0 && Info.n_friendly_attackers > Info.n_enemy_attackers) && closest_robot != null) {
