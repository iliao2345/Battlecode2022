    ...
    public static double query_cheap(MapLocation target_loc, double average_rubble, double wait_cost) throws GameActionException {
		...
		if (this_loc.isWithinDistanceSquared(target_loc, 10)) {
			switch ((target_loc.x-Info.x)+11*(target_loc.y-Info.y)) {
				...
				case -1: return encoded_dist_55 + 0.4375;
				case -11: return encoded_dist_55 + 0.5;
				case 11: return encoded_dist_55 + 0.375;
				case 1: return encoded_dist_55 + 0.3125;
				case -12: return encoded_dist_55 + 0.1875;
				case 10: return encoded_dist_55 + 0.125;
				case -10: return encoded_dist_55 + 0.25;
				case 12: return encoded_dist_55 + 0.0625;
