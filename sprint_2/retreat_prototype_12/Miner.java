...
//				Action.move(Bfs.way_to(lead_loc, Info.rubble_quantile, false));
				Action.move(Bfs.direction(Bfs.query(lead_loc, Info.rubble_quantile, 10, false)));
				return true;
			}
//			else {
...
//				double path_info = 0;
//				MapLocation curr = explore_loc;
//				for (int i=10; --i>=0;) {
//					if (curr.equals(Info.loc)) {
//						break;
//					}
//					path_info = Bfs.query(curr, 100, 10, false);
//					MapLocation last = Bfs.end_location(path_info);
//					rc.setIndicatorLine(curr, last, 0, 0, 255);
//					curr = last;
//				}
				Action.move(Bfs.direction(Bfs.query(explore_loc, 100, 10, false)));
				return true;
			}
		}
		return true;
