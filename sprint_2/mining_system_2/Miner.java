...
//			if (!Comms.enemy_seen_before || !Info.encountered_enemies && Info.spawn_round < 30) {
			if (!seen_enemy_miner && (!Comms.attacker_seen_before || Comms.closest_attacker_dist > (1+Info.average_rubble/10.)*Comms.attacker_seen_round - Info.round_num)) {
