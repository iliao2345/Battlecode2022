package archon_and_mining_details_2;
...
//			controlled_tiles = controlled_tiles_checked/2;
		...
		boolean lacking_miners = Comms.total_miner_count < BEST_MINER_DENSITY * controlled_area && Info.n_friendly_miners < (rc.getRobotCount()-rc.getArchonCount())/2 || Comms.total_miner_count < 0.3*(rc.getRobotCount()-rc.getArchonCount());
...
//		else {
//			miner_rate = 0.1 * 100*self_closest_area/(Info.MAP_WIDTH*Info.MAP_HEIGHT);
//			soldier_rate = 100;
//			builder_rate = 0;
//		}
	}
