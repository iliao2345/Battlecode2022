...
//			charge_damage += robot.type.isBuilding()? 0 : Math.min(robot.health, 0.22*robot.type.health);
//		}
//		
//		RobotInfo weakest_robot = null;
//		int weakest_health = Integer.MAX_VALUE;
...
//		}
//		if (weakest_robot != null) {
//			int attack_damage = Math.min(weakest_robot.health, 45);
//			if (charge_damage > attack_damage && attack_damage != weakest_robot.health) {
//				Action.envision(AnomalyType.CHARGE);
//				return;
//			}
