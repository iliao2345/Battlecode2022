...
//		}
	...
	public static void try_to_mine()  throws GameActionException {
		...
		if (gold_locs.length > 0 && Info.loc.isWithinDistanceSquared(closest_gold_loc, 2)) {
			while (rc.senseGold(closest_gold_loc) > 0 && Info.action_ready) {
				Action.mineGold(closest_gold_loc);
			}
		}
