...
//		}
		...
		miners_needed_locally = Math.max(0, (int)Math.ceil(total_lead/100.));
	}
...
//				return Pathing.approach(most_lead_loc, illegal_tiles);
			...
			else if (miners_needed_locally > rc.senseNearbyRobots(Info.loc.distanceSquaredTo(most_lead_loc)).length) {
