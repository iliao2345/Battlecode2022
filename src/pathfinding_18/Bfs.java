...
public class Bfs {
    ...
    public static Direction way_to(MapLocation target_loc, double average_rubble) throws GameActionException {
        double cost = cost_to(target_loc, average_rubble);
        if (cost == Double.MAX_VALUE) {
            return Direction.CENTER;
        }
        else {
            return Math2.UNIT_DIRECTIONS[(int)(cost*8)%8];
        }
    }
    public static double cost_to(MapLocation target_loc, double average_rubble) throws GameActionException {
		...
		double dist_45 = (rc.onTheMap(loc_45) && rc.canMove(Math2.direction_to(-1, 0)))? dist_55 + 100.5 + rc.senseRubble(loc_45) : Double.MAX_VALUE;
		double dist_54 = (rc.onTheMap(loc_54) && rc.canMove(Math2.direction_to(0, -1)))? dist_55 + 100.75 + rc.senseRubble(loc_54) : Double.MAX_VALUE;
		double dist_56 = (rc.onTheMap(loc_56) && rc.canMove(Math2.direction_to(0, 1)))? dist_55 + 100.25 + rc.senseRubble(loc_56) : Double.MAX_VALUE;
		double dist_65 = (rc.onTheMap(loc_65) && rc.canMove(Math2.direction_to(1, 0)))? dist_55 + 100 + rc.senseRubble(loc_65) : Double.MAX_VALUE;
		double dist_44 = (rc.onTheMap(loc_44) && rc.canMove(Math2.direction_to(-1, -1)))? Math.min(dist_55, Math.min(dist_54, dist_45)) + 100.625 + rc.senseRubble(loc_44) : Double.MAX_VALUE;
		double dist_46 = (rc.onTheMap(loc_46) && rc.canMove(Math2.direction_to(-1, 1)))? Math.min(dist_56, Math.min(dist_55, dist_45)) + 100.375 + rc.senseRubble(loc_46) : Double.MAX_VALUE;
		double dist_64 = (rc.onTheMap(loc_64) && rc.canMove(Math2.direction_to(1, -1)))? Math.min(dist_65, Math.min(dist_55, dist_54)) + 100.875 + rc.senseRubble(loc_64) : Double.MAX_VALUE;
		double dist_66 = (rc.onTheMap(loc_66) && rc.canMove(Math2.direction_to(1, 1)))? Math.min(dist_65, Math.min(dist_56, dist_55)) + 100.125 + rc.senseRubble(loc_66) : Double.MAX_VALUE;
