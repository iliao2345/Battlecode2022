...
//		boolean send_initial_soldiers = Comms.total_miner_count >= Comms.n_starting_archons*3 && rc.getRobotCount()-rc.getArchonCount()-Comms.total_miner_count < Comms.n_starting_archons;
		...
		save_lead_for_transmutation = Comms.builder_exists && rc.getRobotCount()-rc.getArchonCount() > 10*Comms.laboratory_count + 2 && Info.lead < 275;
		make_a_builder = !Comms.builder_exists && rc.getRobotCount()-rc.getArchonCount() > 10*Comms.laboratory_count + 2;
		if (!make_a_builder) {
			builder_urgency = 0;
		}
