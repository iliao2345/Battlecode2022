...
//			}
	...
	public static boolean try_to_move() throws GameActionException {
		...
		if (Comms.closest_attacker_dist < 7 && Comms.attacker_seen_before) {  // flee warzone
			boolean[][] illegal_tiles = new boolean[3][3];
...
//				filled[dir.dx+1][dir.dy+1] = !rc.onTheMap(rc.adjacentLocation(dir)) || rc.isLocationOccupied(rc.adjacentLocation(dir));
//			}
//			boolean[][] filled2 = new boolean[3][3];
//			for (Direction dir:Math2.UNIT_DIRECTIONS) {
//				filled2[dir.dx+1][dir.dy+1] = filled[dir.rotateRight().dx+1][dir.rotateRight().dy+1] && filled[dir.rotateLeft().dx+1][dir.rotateLeft().dy+1];
//			}
//			filled2[1][1] = true;
//			if (Comms.attacker_seen_before && rc.senseNearbyRobots(2, Info.friendly).length >= 2) {
//				for (Direction dir:Direction.allDirections()) {
//					filled2[dir.dx+1][dir.dy+1] = dir.dx*Comms.closest_attacker_dx + dir.dy*Comms.closest_attacker_dy >= 0;
//				}
//			}
...
//		}
		if (Info.move_ready) {  // explore
			Exploration.repel(Info.friendly_miners, Info.n_friendly_miners);
