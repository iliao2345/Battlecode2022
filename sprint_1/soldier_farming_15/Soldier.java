...
//	public static boolean saw_enemy_last_turn = false;
	
	public static void update() throws GameActionException {
//		saw_enemy_last_turn = Info.enemy_robots.length > 0;
	}
...
//		}
	...
	public static void act() throws GameActionException {
		...
		if (Info.move_ready) {
			if (Info.health <= 5 && Info.lead < Archon.LEAD_SATURATION_CAP) {
				if (rc.senseLead(Info.loc) == 0 && Comms.closest_attacker_dist > 15) {
					...
					Exploration.avoid(Info.enemy_soldiers, Info.n_enemy_soldiers);
				}
			}
